...
import { SafeAreaView, View, Text, FlatList, ScrollView, Dimensions, Image, ImageBackground } from 'react-native';
  ...
  return (
    <SafeAreaView>
      ...
      <FlatList
        ...
        // numColumns={2}
        ListHeaderComponent={ListHeader} //Rendered at the top of all the items.
